...
export const placeholderMilestones: StoryMilestone[] = [
  ...
  },
  {
    ...
    description: "New cities, familiar faces, and the quiet certainty that we were building something worth keeping.",
    order: 4,
  },
  {
    _id: "milestone-5",
    _type: "storyMilestone",
    date: "2025",
    title: "A year of knowing",
    description: "Some years are not defined by milestones but by a deepening — this was one of those years.",
    order: 5,
  },
  {
    _id: "milestone-6",
  ...
  },
  {
    ...
    date: "January 2027",
    title: "The wedding",
    description: "And now, surrounded by the people we love most, we begin.",
    order: 7,
  },
]
