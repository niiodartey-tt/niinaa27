  ...
  return (
    <SectionWrapper id="gift-guide" className="relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto text-center">
        <Gift size={22} aria-hidden="true" className="text-gold-base mx-auto mb-3" />
        ...
        <div className="mt-10 md:mt-12 rounded-card bg-gold-highlight/15 border border-gold-base/20 p-6 text-left max-w-xs mx-auto">
