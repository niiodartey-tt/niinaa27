  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-xl mx-auto animate-fade-up [text-shadow:_0_0_8px_rgba(255,255,255,0.7)]">
        ...
        <a
          href="#rsvp"
          className="mt-8 inline-flex items-center rounded-full border border-gold-base bg-ivory/15 backdrop-blur-sm hover:bg-ivory/25 text-gold-base font-serif text-sm tracking-widest uppercase px-10 py-3.5 min-h-[44px] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-base focus-visible:ring-offset-2 focus-visible:ring-offset-ink [text-shadow:_0_2px_8px_rgba(0,0,0,0.9),_0_4px_16px_rgba(0,0,0,0.6)]"
        >
          Kindly RSVP
        </a>
      </div>
